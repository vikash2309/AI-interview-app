...
class DistributionCredentialsClient {
    ...
    __list(project_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/projects/{project_id}/self-hosted/distribution/credentials");
        });
    }
    /**
    ...
    __create(project_id_1) {
        return __awaiter(this, arguments, void 0, function* (project_id, request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "POST", "/v1/projects/{project_id}/self-hosted/distribution/credentials");
        });
    }
    /**
    ...
    get(project_id, distribution_credentials_id, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__get(project_id, distribution_credentials_id, requestOptions));
    }
    __get(project_id, distribution_credentials_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/projects/{project_id}/self-hosted/distribution/credentials/{distribution_credentials_id}");
        });
    }
    /**
    ...
    delete(project_id, distribution_credentials_id, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__delete(project_id, distribution_credentials_id, requestOptions));
    }
    __delete(project_id, distribution_credentials_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "DELETE", "/v1/projects/{project_id}/self-hosted/distribution/credentials/{distribution_credentials_id}");
        });
    }
}
exports.DistributionCredentialsClient = DistributionCredentialsClient;
