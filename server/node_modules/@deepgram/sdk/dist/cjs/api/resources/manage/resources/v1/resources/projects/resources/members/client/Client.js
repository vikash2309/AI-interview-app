...
const Client_js_2 = require("../resources/scopes/client/Client.js");
class MembersClient {
    constructor(options = {}) {
    ...
    get invites() {
        var _a;
        return ((_a = this._invites) !== null && _a !== void 0 ? _a : (this._invites = new Client_js_1.InvitesClient(this._options)));
    }
    get scopes() {
        var _a;
        return ((_a = this._scopes) !== null && _a !== void 0 ? _a : (this._scopes = new Client_js_2.ScopesClient(this._options)));
    }
    /**
    ...
    __list(project_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/v1/projects/{project_id}/members");
        });
    }
    /**
    ...
    __delete(project_id, member_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "DELETE", "/v1/projects/{project_id}/members/{member_id}");
        });
    }
}
