...
export declare class VariablesClient {
     ...
     */
    list(project_id: string, requestOptions?: VariablesClient.RequestOptions): core.HttpResponsePromise<Deepgram.ListAgentVariablesV1Response>;
    private __list;
    /**
     ...
     *     })
     */
    create(project_id: string, request: Deepgram.voiceAgent.CreateAgentVariableV1Request, requestOptions?: VariablesClient.RequestOptions): core.HttpResponsePromise<Deepgram.AgentVariableV1>;
    private __create;
    /**
     ...
     */
    get(project_id: string, variable_id: string, requestOptions?: VariablesClient.RequestOptions): core.HttpResponsePromise<Deepgram.AgentVariableV1>;
    private __get;
    /**
     ...
     */
    delete(project_id: string, variable_id: string, requestOptions?: VariablesClient.RequestOptions): core.HttpResponsePromise<Deepgram.DeleteAgentVariableV1Response>;
    private __delete;
    /**
     ...
     *     })
     */
    update(project_id: string, variable_id: string, request: Deepgram.voiceAgent.UpdateAgentVariableV1Request, requestOptions?: VariablesClient.RequestOptions): core.HttpResponsePromise<Deepgram.AgentVariableV1>;
    private __update;
}
