...
const require_error = require('./_chunks/error-kQD0GNXJ.js');
...
const require_versionSelector = require('./_chunks/versionSelector-ovAV8epG.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.15.0");
