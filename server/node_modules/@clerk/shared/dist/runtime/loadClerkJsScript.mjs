...
import { y as buildErrorThrower } from "./_chunks/error-DAG0ASPV.mjs";
...
import { n as versionSelector } from "./_chunks/versionSelector-BGVqbSYj.mjs";
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = versionSelector(__internal_clerkUIVersion, "1.15.0");
